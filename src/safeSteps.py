...
def main():
    ...
    out = cv2.VideoWriter('test_videos/visioneye-distance-calculation.avi', cv2.VideoWriter_fourcc(*'MJPG'), fps, (w, h))
    pixel_per_meter = 70
    txt_color, txt_background, bbox_clr = ((0, 0, 0), (255, 255, 255), (255, 0, 255))
    txt_color_2, txt_background_2, bbox_clr_2 = ((119, 7, 55), (255, 182, 193), (255, 0, 255))
    # Video capture
    cap = cv2.VideoCapture('test_videos/vid1.mp4') # Replace 'your_video.mp4' with your video file
    ...
    while True:
        ...
        model2 = YOLO("../trained_models/yolov8n.pt")
        ...
        if results2[0].boxes.id is not None:
            ...
            for box, track_id in zip(boxes, track_ids):
                ...
                if track_id in prev_coordinates:
                    ...
                    if distance <= 1.76 or  distance_2 <= 1.76: # Moving in radius of 1 vision eye.
                        valid = False
